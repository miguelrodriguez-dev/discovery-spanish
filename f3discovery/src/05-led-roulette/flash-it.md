...
no se ejecuta `openocd`, para que se abra una sesión de GDB y programe el chip al mismo tiempo, y esperando a nuevas órdenes en la sesión de GDB. Esto lo
veremos en la sección de depuración.
